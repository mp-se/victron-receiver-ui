<template>
    <div class="container">
        ...
        <div class="row gy-2">
            ...
            <div class="col-md-3">
                <button @click="clear" type="button" class="btn btn-primary w-2" :disabled="!isConnected">Clear</button>
            </div>
            <div class="col-md-3">
                <button @click="connect" type="button" class="btn btn-secondary w-2"
