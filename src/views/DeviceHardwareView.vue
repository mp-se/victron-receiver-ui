    ...
    <div class="container">
        ...
        <form @submit.prevent="save" class="needs-validation" novalidate>
            <div class="row">
                ...
                <div class="col-md-4">
                    <BsInputNumber v-model="config.ble_scan_time" unit="s" label="Scanning Time"
                        width="3" :disabled="global.disabled"></BsInputNumber>
                </div>
                <div class="col-md-4">
                    <BsSelect v-model="config.timezone" :options="timezoneOptions" label="Timezone"
                        width="" :disabled="global.disabled"></BsSelect>
                </div>
